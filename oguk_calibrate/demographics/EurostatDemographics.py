...
#     "demo_magec", StartPeriod, EndPeriod, filter_pars, flags=True, verbose=True
# )
...
indexNames = df_pop[
    (df_pop["AGE"] == "TOTAL") | (df_pop["AGE"] == "UNK") | (df_pop["AGE"] == "Y_OPEN")
].index
...
x_44_over50 = np.linspace(1, len(Y_44_49) + num_over50, len(Y_44_49) + num_over50)
...
x_under15_17 = np.linspace(1, len(Y_15_17) + num_under15, len(Y_15_17) + num_under15)

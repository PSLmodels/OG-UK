...
then
    ...
    echo "Look at the CHANGELOG.md file to learn how the version number should be updated."
    exit 1
fi
...
then
    ...
    echo "Look at the CHANGELOG.md file to learn how to write the changelog."
    exit 2
fi

...
_HIST_GVA_BY_SECTOR = {
    ...
    #         Energy  Manuf  Const  Trade  InfoF  RealE  BusSv  PubOt
    "2000-01": [21.5, 128.7, 55.6, 194.1, 119.2, 126.7, 108.0, 272.7],
    "2001-02": [21.2, 126.5, 58.4, 201.9, 127.5, 138.3, 114.0, 286.0],
    "2002-03": [20.6, 124.0, 63.0, 210.2, 131.5, 148.9, 120.3, 303.2],
    "2003-04": [20.9, 124.1, 67.3, 219.8, 137.1, 156.0, 128.7, 321.8],
    "2004-05": [22.3, 126.0, 70.8, 228.5, 143.4, 161.8, 136.7, 337.5],
    "2005-06": [25.6, 127.6, 75.4, 237.9, 150.6, 169.0, 145.3, 353.1],
    "2006-07": [27.0, 130.4, 81.0, 249.6, 162.0, 177.6, 157.0, 364.6],
    "2007-08": [29.8, 133.0, 87.0, 258.7, 176.9, 182.7, 167.5, 376.4],
    "2008-09": [34.5, 127.1, 81.2, 251.3, 179.8, 179.5, 163.3, 391.3],
    "2009-10": [28.0, 118.5, 72.7, 240.2, 170.3, 179.0, 153.6, 397.5],
    "2010-11": [31.2, 127.1, 77.0, 254.1, 178.3, 187.4, 161.9, 404.9],
    "2011-12": [35.0, 130.1, 80.5, 262.5, 185.6, 192.5, 167.7, 411.8],
    "2012-13": [33.5, 131.4, 82.1, 270.5, 192.1, 200.8, 173.4, 419.1],
    "2013-14": [33.0, 136.2, 87.8, 281.5, 200.0, 210.3, 182.8, 428.3],
    "2014-15": [28.2, 140.7, 95.5, 296.2, 214.0, 223.0, 193.6, 441.6],
    "2015-16": [22.1, 144.3, 99.5, 310.0, 228.2, 236.5, 197.8, 451.4],
    "2016-17": [41.8, 174.8, 111.4, 349.5, 259.4, 257.4, 214.2, 474.2],
    "2017-18": [44.0, 178.6, 118.3, 363.4, 270.5, 262.7, 224.1, 489.2],
    "2018-19": [48.3, 181.5, 125.5, 377.3, 282.0, 268.6, 233.0, 501.6],
    "2019-20": [40.7, 181.3, 126.4, 370.1, 290.3, 271.2, 237.3, 510.5],
    "2020-21": [30.1, 168.1, 113.1, 303.5, 289.3, 273.7, 216.5, 514.5],
    "2021-22": [46.9, 183.6, 127.8, 376.2, 308.8, 284.3, 243.4, 524.1],
    "2022-23": [54.8, 195.4, 134.5, 413.0, 332.0, 299.0, 265.9, 537.6],
    "2023-24": [48.2, 195.0, 140.1, 421.3, 344.4, 310.2, 274.6, 555.1],
    # fmt: on
}
...
_HIST_CAPITAL_BY_SECTOR = {
    ...
    #         Energy  Manuf  Const  Trade  InfoF  RealE   BusSv  PubOt
    "2000-01": [105, 105, 14, 128, 72, 610, 38, 270],
    "2002-03": [100, 100, 15, 133, 80, 660, 40, 280],
    "2004-05": [100, 97, 16, 140, 85, 730, 43, 295],
    "2006-07": [108, 100, 18, 153, 95, 840, 50, 315],
    "2008-09": [130, 110, 20, 170, 108, 940, 58, 340],
    "2010-11": [135, 112, 20, 168, 112, 970, 59, 350],
    "2012-13": [145, 118, 21, 178, 120, 1040, 64, 365],
    "2014-15": [150, 122, 22, 185, 128, 1100, 69, 380],
    "2016-17": [155, 128, 24, 195, 135, 1170, 74, 400],
    "2018-19": [170, 140, 26, 208, 146, 1250, 82, 425],
    "2019-20": [175, 143, 27, 210, 148, 1280, 83, 430],
    "2020-21": [172, 142, 27, 207, 150, 1310, 82, 440],
    "2021-22": [181, 152, 29, 223, 161, 1400, 89, 465],
    "2022-23": [197, 168, 32, 248, 178, 1510, 98, 495],
}
...
_HIST_LABOUR_BY_SECTOR = {
    ...
    #         Energy  Manuf   Const  Trade  InfoF  RealE  BusSv  PubOt
    "2000-01": [125, 3800, 1820, 7400, 1650, 380, 3900, 7800],
    "2002-03": [115, 3510, 1870, 7500, 1700, 400, 4100, 8000],
    "2004-05": [110, 3250, 1950, 7600, 1750, 420, 4350, 8150],
    "2006-07": [115, 3050, 2100, 7750, 1850, 450, 4650, 8300],
    "2008-09": [120, 2910, 2150, 7700, 1900, 470, 4800, 8450],
    "2010-11": [115, 2650, 2050, 7500, 1950, 470, 4700, 8500],
    "2012-13": [125, 2600, 2050, 7700, 2050, 490, 4950, 8550],
    "2014-15": [135, 2600, 2100, 7900, 2150, 510, 5150, 8600],
    "2016-17": [155, 2620, 2190, 8150, 2300, 540, 5380, 8640],
    "2017-18": [157, 2630, 2250, 8260, 2350, 550, 5480, 8700],
    "2018-19": [160, 2620, 2280, 8340, 2410, 560, 5560, 8760],
    "2019-20": [161, 2610, 2300, 8320, 2450, 570, 5600, 8800],
    "2020-21": [152, 2490, 2170, 7750, 2420, 530, 5240, 8700],
    "2021-22": [162, 2530, 2250, 8180, 2510, 570, 5580, 8850],
    "2022-23": [178, 2590, 2310, 8470, 2580, 590, 5760, 8960],
